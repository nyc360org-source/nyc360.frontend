...
export class EditRentingComponent implements OnInit {
    ...
    populateForm(data: any) {
        this.form.patchValue({
            ...
            MonthlyRent: data.monthlyRent || data.startingPrice,
            ...
            Heating: data.heating || data.heatingSystem,
            Cooling: data.cooling || data.coolingSystem,
            ...
            LeaseType: data.leaseType || data.rentingLeaseType,
            PrivacyType: data.privacyType || (data.rentingIsShared ? 1 : 0),
            SharedBathroomType: data.sharedBathroomType || (data.rentingIsSharedBathroom ? 1 : 0),
            SharedKitchenType: data.sharedKitchenType || (data.rentingIsSharedKitchen ? 1 : 0),
    ...
    onSubmit(isPublished: boolean = true) {
        ...
        if (this.postId) {
            this.housingService.updateRentingPost(this.postId, payload).subscribe({
                next: (res: any) => {
