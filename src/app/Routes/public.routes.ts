    ...
    children: [
      ...
      // forums
      {
        ...
        children: [
          ...
          { path: 'questions/:id', loadComponent: () => import('../pages/Public/pages/forums/pages/question-details/question-details.component').then(m => m.QuestionDetailsComponent) },
          { path: ':slug/create', loadComponent: () => import('../pages/Public/pages/forums/pages/create-question/create-question.component').then(m => m.CreateQuestionComponent) },
